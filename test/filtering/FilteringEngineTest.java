...
public class FilteringEngineTest {
	 ...
	 */
	@Test
	public final void testSetupFilteringEngineHappyDay(){
		int setUpCorrectly = filteringEngine.setupFilteringEngine(atomicFilters, metadataManager);
		assertEquals(0, setUpCorrectly);
	}
